...
/**
        * Compute the 3D rotation error between two matrix E_a_b and E_a_c in
 * the 'a' frame.
        * This method convert the 3D rotation matrix E_b_c into a rotation
 * vector.
...
/**
        * Compute the 3D rotation vector of the rotation matrix E_a_b in the 'a'
 * frame.
...
/**
        ...
        * This method convert the 6D transformation matrix X_b_c into a motion
 * vector.
        * The matrix X_b_c is computed as follow X_a_c = X_b_c*X_a_b.
        * Then the error is computed with
 * PTransform(E_b_a)*transformVelocity(X_b_c).
        * @param prec Deprecated.
        * @return XYZ rotation in radian.
        */
template <typename T>
