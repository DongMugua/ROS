...
/**
        * Utility function to compute a rotation matrix from the parameter
 * vector.
...
/**
        ...
        * Hold joint name (used as identifier) and compute transformation, speed
 * and motion
        * subspace.
        * WARNING : Free joint translation parameters are in FP coordinate
 * (Example 4.5 p81).
        */
class Joint {
 public:
 ...
 public:
  ...
  /**
          * Compute the joint transformation from predecessor to successor
   * frame.
  ...
  /**
          ...
          * @see pose
          * @throw std::domain_error If the number of generalized position
   * variable is
          * wrong.
          */
  ...
  /**
          ...
          * @see motion
          * @throw std::domain_error If the number of generalized speed variable
   * is
          * wrong.
          */
  ...
  /**
          ...
          * @see tanAccel
          * @throw std::domain_error If the number of generalized acceleration
   * variable is
          * wrong.
          */
