...
/**
         ...
         * @oaram comA CoM acceleration in world frame, this must be computed
  *without
         *	the gravity term
         * @param altitude Double representing the surface's altitude in world
  *frame
         * @return ZMP
         */
...
/**
         * @brief Compute the ZMP in the world frame considering that gravity is
  *taken
         * into account in the CoM acceleration
         * @param com CoM position in world frame
         * @param comA CoM acceleration in world frame, this must be computed
  *with
         *	the gravity term
         * @param altitude Double representing the surface's altitude in world
  *frame
...
/**
         * @brief Compute the ZMP considering the external wrench applied on the
  *robot
