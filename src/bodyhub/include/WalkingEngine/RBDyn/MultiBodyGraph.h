...
class MultiBodyGraph {
 ...
 public:
  ...
  /**
          ...
          * @param isB1toB2 If true use the joint forward value as body 1 to
   * body 2
          * forward value of the joint and the inverse value for body 2 to body
   * 1
          * joint. If false the behavior is inversed.
          * @throw std::out_of_range If b1Name or b2Name or jointName don't
   * exist.
          */
   ...
   * matrix)
          * @param rootBodyName Name of graph root.
          * @param jointName Merge all node after jointName in jointName parent
   * node.
  ...
  /**
          * Compute the transformation to apply on each bodies to find their
   * original
          * base.
          * @param rootBodyName Name of graph root.
          * @param X_b0_j0 Transformation from the root body to the root joint.
  ...
  /**
    ...
    * @param fixAllJoints If true, all joints are fixed. The value of
   * jointsToFix is disregarded.
 ...
 private:
  ...
  /**
          * Remove all joint with same id than Arc::joint from MultiBodyGraph
   * and call
  ...
  /**
          * Merge parent and child inertia with parent in inertia in parent body
   * base
