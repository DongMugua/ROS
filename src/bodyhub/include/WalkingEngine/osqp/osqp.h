 ...
 */
c_int osqp_update_P(OSQPWorkspace *work, c_float *Px_new, c_int *Px_new_idx,
                    c_int P_new_n);
 ...
 *                                 <0: error in the update
 */
c_int osqp_update_A(OSQPWorkspace *work, c_float *Ax_new, c_int *Ax_new_idx,
                    c_int A_new_n);
...
c_int osqp_update_P_A(OSQPWorkspace *work, c_float *Px_new, c_int *Px_new_idx,
                      c_int P_new_n, c_float *Ax_new, c_int *Ax_new_idx,
                      c_int A_new_n);
