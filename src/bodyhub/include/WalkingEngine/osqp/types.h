...
#ifndef EMBEDDED
  c_int
      status_polish;  ///< polish status: successful (1), unperformed (0), (-1)
                      // unsuccessful
...
typedef struct {
  ...
  c_float
      adaptive_rho_tolerance;  ///< Tolerance X for adapting rho. The new rho
...
struct linsys_solver {
  ...
  c_int (*update_matrices)(
      LinSysSolver *self, const csc *P, const csc *A,
