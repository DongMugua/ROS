...
*******************/
#define OSQP_VERSION                                         \
  ("0.3.0") /* string literals automatically null-terminated \
               */
...
#define OSQP_UNSOLVED                                    \
  (-10) /* Unsolved. Only setup function has been called \
           */
...
static const char *LINSYS_SOLVER_NAME[] = {"suitesparse ldl", "mkl pardiso"};
